...
String errorMessageLastNameNull = WebUI.getText(findTestObject('YourInformation_Page/Label_ErrorMessage'))

'Jika error message sudah sesuai akan menamppilkan error message sudah sesuai jika belum akan menampilkan BELUM sesuai'
if (errorMessageLastNameNull.equals(errorLastNameNull)) {
    println('Error message sudah sesuai: ' + errorMessageLastNameNull)
} else {
    KeywordUtil.markFailed('Error message BELUM sesuai: ' + errorMessageLastNameNull)
}
