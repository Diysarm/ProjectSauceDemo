...
String errorMessageFirstNameNull = WebUI.getText(findTestObject('YourInformation_Page/Label_ErrorMessage'))

'Jika error message sudah sesuai akan menamppilkan error message sudah sesuai jika belum akan menampilkan BELUM sesuai'
if (errorMessageFirstNameNull.equals(errorFirstNameNull)) {
    println('Error message sudah sesuai: ' + errorMessageFirstNameNull)
} else {
    KeywordUtil.markFailed('Error message BELUM sesuai: ' + errorMessageFirstNameNull)
}
